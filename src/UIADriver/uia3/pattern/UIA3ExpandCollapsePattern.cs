...
namespace UIADriver.uia3.pattern
{
    public class UIA3ExpandCollapsePattern : ExpandCollapsePatternService<IUIAutomationElement, IUIAutomationCacheRequest>
    {
        ...
        public UIA3ExpandCollapsePattern(ElementFinderService<IUIAutomationElement, IUIAutomationCacheRequest> finderService, ElementAttributeService<IUIAutomationElement> attributeService, IUIAutomation automation) : base(finderService, attributeService)
        {
