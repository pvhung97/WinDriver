...
namespace UIADriver.uia3.sourcebuilder
{
    ...
    {
        public RootPageSourceBuilder(IUIAutomation automation, SessionCapabilities capabilities, ServiceProvider<IUIAutomationElement, IUIAutomationCacheRequest> serviceProvider) : base(automation, capabilities, serviceProvider) { }
