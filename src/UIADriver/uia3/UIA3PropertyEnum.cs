...
namespace UIADriver.uia3
{
    public enum UIA3PropertyEnum
    {
        ...
        GridItem_Row = UIA_PropertyIds.UIA_GridItemRowPropertyId,
        GridItem_Column = UIA_PropertyIds.UIA_GridItemColumnPropertyId,
        GridItem_RowSpan = UIA_PropertyIds.UIA_GridItemRowSpanPropertyId,
        GridItem_ColumnSpan = UIA_PropertyIds.UIA_GridItemColumnSpanPropertyId,
        GridItem_ContainingGrid = UIA_PropertyIds.UIA_GridItemContainingGridPropertyId,
